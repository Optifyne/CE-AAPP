**❗ Join original [ConditionalEvents Discord](https://discord.com/channels/698332177137401987/1348313697436569733) to the origin of this addon ❗**
...
### Currently the addon has 51 new actions and 26 new placeholders with different subplaceholders.
...
➡️ **With placeholders**: ``get item information from entities, players and storages, check for LuckPerms permissions with contexts, get highest block on location, get biomes on location, get random block in radius, get entities in radius, check if an entity is in water, process arrays, get real nickname by custom nickname in Essentials, get information about /team teams, get entity health, location, name, type, air level, frozeness, burnness etc information by UUID, save and obtain custom data (custom variables), get entity’s passengers, get player's open inventory and many more.``
