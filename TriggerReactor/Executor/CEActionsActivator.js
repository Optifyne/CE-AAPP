...
function CEActionsActivator() {
    if (isPluginEnabled(plugin)) {
        ...
        try {
            ...
            var CEmanageHurtSoundListener = systemProperties.get("CEmanageHurtSoundListener");
           	if (CEmanageHurtSoundListener) {
                protocolManager.removePacketListener(CEmanageHurtSoundListener);
