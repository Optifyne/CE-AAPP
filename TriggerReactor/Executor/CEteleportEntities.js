    ...
    var TeleportEntitiesAction = Java.extend(ConditionalEventsAction, {
        execute: function(player, actionLine, minecraftEvent) {
            ...
            if (args.length < 5 || args.length > 6) {
                Bukkit.getLogger().warning("[CEActions] TELEPORT_ENTITIES ACTION: Invalid actionLine format! CORRECT FORMAT: teleport_entities: <entity_uuids|player_names>;<world>;<x>;<y>;<z>;(optional) <target_entity_uuid|target_player_name>");
                return;
            }
            ...
            if (world == null && targetIdentifierToTeleport == null) {
