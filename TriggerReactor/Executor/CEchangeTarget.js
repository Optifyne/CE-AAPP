    ...
    var ChangeTargetAction = Java.extend(ConditionalEventsAction, {
        execute: function(player, actionLine, minecraftEvent) {
            ...
            if (args.length < 1 || args.length > 2) {
                Bukkit.getLogger().warning("[CEActions] CHANGE_TARGET ACTION: Invalid actionLine format! CORRECT FORMAT: change_target: <entity_uuid>;(optional, skip to remove the target) <target_uuid|target_player_name>");
                return;
            }
